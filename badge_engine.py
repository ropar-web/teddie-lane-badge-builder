...
FONT_FILES = {
    "Jua — closest match": ROOT / "assets/fonts/jua/Jua-Regular.ttf",
    "Concert One": ROOT / "assets/fonts/concert-one/ConcertOne-Regular.ttf",
    "Barlow Condensed SemiBold": ROOT / "assets/fonts/barlow-condensed/BarlowCondensed-SemiBold.ttf",
}

SHAPES = {
    "Uploaded Shape 1 — exact SVG": {
        "file": ROOT / "assets/shapes/shape-1.svg",
